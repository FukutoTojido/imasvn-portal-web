...
export default function RightBar() {
	...
	return userData.authType === UserType.OK && userData.isJoinedServer ? (
		<div className="max-w-[300px] w-full h-min flex flex-col gap-2.5 self-start sticky top-[90px]">
			<button
				type="button"
				className="lg:relative fixed bottom-0 right-0 lg:m-0 m-4 lg:shadow-none shadow-md flex gap-5 justify-center px-5 py-[15px] font-bold rounded-lg bg-text hover:bg-subtext-1 text-cat-base items-center"
